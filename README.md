...
> **Note:** The `data-slug` value uses the format `category-slug/tool-slug`. Find available tools at [peasysocial.com/api/v1/tools/](https://peasysocial.com/api/v1/tools/).
...
Embed [PeasySocial](https://peasysocial.com) widgets on any website with [peasy-social-embed](https://widget.peasysocial.com):

```html
<script src="https://cdn.jsdelivr.net/npm/peasy-social-embed@1/dist/embed.min.js"></script>
<div data-peasysocial="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.peasysocial.com)
